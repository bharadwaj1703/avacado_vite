...
var useStateWithDeps = (initialState) => {
  const [, rerender] = (0, import_react2.useState)({});
  const unmountedRef = (0, import_react2.useRef)(false);
  const stateRef = (0, import_react2.useRef)(initialState);
  const stateDependenciesRef = (0, import_react2.useRef)({
    data: false,
    error: false,
    isValidating: false
  });
  const setState = (0, import_react2.useCallback)((payload) => {
...
var mutation = () => (key, fetcher, config = {}) => {
  ...
  const ditchMutationsUntilRef = (0, import_react2.useRef)(0);
...
var createContextAndHook = (displayName, options) => {
  ...
  const Ctx = import_react3.default.createContext(void 0);
  Ctx.displayName = displayName;
  const useCtx = () => {
    const ctx = import_react3.default.useContext(Ctx);
...
function SWRConfigCompat({ swrConfig, children }) {
  return import_react3.default.createElement(SWRConfig, { value: swrConfig }, children);
}
var [ClerkInstanceContext, useClerkInstanceContext] = createContextAndHook("ClerkInstanceContext");
var [UserContext, useUserContext] = createContextAndHook("UserContext");
var [ClientContext, useClientContext] = createContextAndHook("ClientContext");
var [SessionContext, useSessionContext] = createContextAndHook("SessionContext");
var OptionsContext = import_react3.default.createContext({});
...
var __experimental_CheckoutProvider = ({ children, ...rest }) => {
  return import_react3.default.createElement(CheckoutContext.Provider, { value: { value: rest } }, children);
};
var [OrganizationContextInternal, useOrganizationContext] = createContextAndHook("OrganizationContext");
var OrganizationProvider = ({ children, organization, swrConfig }) => {
  return import_react3.default.createElement(SWRConfigCompat, { swrConfig }, import_react3.default.createElement(OrganizationContextInternal.Provider, { value: { value: { organization } } }, children));
};
function useAssertWrappedByClerkProvider(displayNameOrFn) {
  if (!import_react3.default.useContext(ClerkInstanceContext)) {
...
var useWithSafeValues = (params, defaultValues) => {
  ...
  const initialPageRef = (0, import_react3.useRef)(shouldUseDefaults ? defaultValues.initialPage : params?.initialPage ?? defaultValues.initialPage);
...
var usePagesOrInfinite = (params) => {
  ...
  const [paginatedPage, setPaginatedPage] = (0, import_react3.useState)(config.initialPage ?? 1);
  const initialPageRef = (0, import_react3.useRef)(config.initialPage ?? 1);
  const pageSizeRef = (0, import_react3.useRef)(config.pageSize ?? 10);
...
function useAttemptToEnableOrganizations(caller) {
  ...
  const hasAttempted = (0, import_react3.useRef)(false);
...
var useCheckout = (options) => {
  ...
  const manager = (0, import_react3.useMemo)(() => clerk.__experimental_checkout({
    planId,
    planPeriod,
    for: forOrganization
  }), [
  ...
  const managerProperties = (0, import_react3.useSyncExternalStore)((cb) => manager.subscribe(cb), () => manager.getState(), () => manager.getState());
  return { checkout: {
...
var useAttachEvent = (element, event, cb) => {
  const cbDefined = !!cb;
  const cbRef = (0, import_react3.useRef)(cb);
  (0, import_react3.useEffect)(() => {
    cbRef.current = cb;
  }, [cb]);
  (0, import_react3.useEffect)(() => {
...
var ElementsContext = import_react3.default.createContext(null);
...
var Elements = (({ stripe: rawStripeProp, options, children }) => {
  const parsed = import_react3.default.useMemo(() => parseStripeProp(rawStripeProp), [rawStripeProp]);
  const [ctx, setContext] = import_react3.default.useState(() => ({
  ...
  return import_react3.default.createElement(ElementsContext.Provider, { value: ctx }, children);
});
var useElementsContextWithUseCase = (useCaseMessage) => {
  return parseElementsContext(import_react3.default.useContext(ElementsContext), useCaseMessage);
};
var useElements = () => {
...
var useElementsOrCheckoutSdkContextWithUseCase = (useCaseString) => {
  return parseElementsContext(import_react3.default.useContext(ElementsContext), useCaseString);
};
...
var createElementComponent = (type, isServer) => {
  ...
  const ClientElement = ({ id, className, fallback, options = {}, onBlur, onFocus, onReady, onChange, onEscape, onClick, onLoadError, onLoaderStart, onNetworksChange, onConfirm, onCancel, onShippingAddressChange, onShippingRateChange }) => {
    ...
    const [element, setElement] = import_react3.default.useState(null);
    const elementRef = import_react3.default.useRef(null);
    const domNode = import_react3.default.useRef(null);
    const [isReady, setReady] = (0, import_react3.useState)(false);
    ...
    return import_react3.default.createElement(import_react3.default.Fragment, null, !isReady && fallback, import_react3.default.createElement("div", {
      id,
      style: {
...
var ValidateStripeUtils = ({ children }) => {
  ...
  return import_react3.default.createElement(StripeUtilsContext.Provider, { value: { value: {
    stripe,
    elements
  } } }, children);
};
var DummyStripeUtils = ({ children }) => {
  return import_react3.default.createElement(StripeUtilsContext.Provider, { value: { value: {} } }, children);
};
var PropsProvider = ({ children, ...props }) => {
  const utils = usePaymentSourceUtils(props.for);
  const [isPaymentElementReady, setIsPaymentElementReady] = (0, import_react3.useState)(false);
  return import_react3.default.createElement(PaymentElementContext.Provider, { value: { value: {
    ...props,
    ...utils,
...
var PaymentElementProvider = ({ children, ...props }) => {
  return import_react3.default.createElement(PropsProvider, props, import_react3.default.createElement(PaymentElementInternalRoot, null, children));
};
var PaymentElementInternalRoot = (props) => {
  const { stripe, externalClientSecret, stripeAppearance } = usePaymentElementContext();
  const locale = useLocalization();
  if (stripe && externalClientSecret) return import_react3.default.createElement(Elements, {
  ...
  }, import_react3.default.createElement(ValidateStripeUtils, null, props.children));
  return import_react3.default.createElement(DummyStripeUtils, null, props.children);
};
var PaymentElement = ({ fallback }) => {
  ...
  const environment = useInternalEnvironment();
  const applePay = (0, import_react3.useMemo)(() => {
  ...
  if (!stripe || !externalClientSecret) return import_react3.default.createElement(import_react3.default.Fragment, null, fallback);
  return import_react3.default.createElement(PaymentElement$1, {
    fallback,
    onReady,
    options
  });
...
var usePaymentElement = () => {
  ...
  const reset = (0, import_react3.useCallback)(async () => {
    if (!stripe || !elements) return throwLibsMissingError();
...
function useEmailLink(resource) {
  const { startEmailLinkFlow, cancelEmailLinkFlow } = import_react8.default.useMemo(() => resource.createEmailLinkFlow(), [resource]);
...
var assertSingleChild = (children) => (name) => {
  try {
    return import_react16.default.Children.only(children);
  } catch {
...
var normalizeWithDefaultValue = (children, defaultText) => {
  ...
  if (typeof children === "string") {
    children = import_react16.default.createElement("button", null, children);
  }
  return children;
};
...
function withMaxAllowedInstancesGuard(WrappedComponent, name, error) {
  ...
  const Hoc = (props) => {
    ...
    return import_react17.default.createElement(WrappedComponent, { ...props });
  };
  Hoc.displayName = `withMaxAllowedInstancesGuard(${displayName})`;
  return Hoc;
}
var useCustomElementPortal = (elements) => {
  const [nodeMap, setNodeMap] = (0, import_react18.useState)(/* @__PURE__ */ new Map());
...
var isThatComponent = (v, component) => {
  return !!v && import_react20.default.isValidElement(v) && (v == null ? void 0 : v.type) === component;
};
...
var useCustomMenuItems = ({
  ...
  import_react21.default.Children.forEach(children, (child) => {
    ...
    const { props } = child;
    import_react21.default.Children.forEach(props.children, (child2) => {
...
function useWaitForComponentMount(component, options) {
  const watcherRef = (0, import_react22.useRef)();
  const [status, setStatus] = (0, import_react22.useState)("rendering");
...
var ClerkHostRenderer = class extends import_react24.default.PureComponent {
  constructor() {
    super(...arguments);
    this.rootRef = import_react24.default.createRef();
  }
  ...
  render() {
    ...
    return import_react24.default.createElement(import_react24.default.Fragment, null, !hideRootHtmlElement && import_react24.default.createElement("div", { ...rootAttributes }), this.props.children);
  }
};
var CustomPortalsRenderer = (props) => {
  var _a, _b;
  return import_react15.default.createElement(import_react15.default.Fragment, null, (_a = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a.map((portal, index) => (0, import_react15.createElement)(portal, { key: index })), (_b = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react15.createElement)(portal, { key: index })));
};
var SignIn = withClerk(
  ({ clerk, component, fallback, ...props }) => {
    ...
    return import_react15.default.createElement(import_react15.default.Fragment, null, shouldShowFallback && fallback, clerk.loaded && import_react15.default.createElement(
      ClerkHostRenderer,
      {
        component,
...
var _UserProfile = withClerk(
  ({
    ...
    return import_react15.default.createElement(import_react15.default.Fragment, null, shouldShowFallback && fallback, import_react15.default.createElement(
      ClerkHostRenderer,
      {
        component,
      ...
      import_react15.default.createElement(CustomPortalsRenderer, { customPagesPortals })
    ));
  },
...
var _UserButton = withClerk(
  ({
    ...
    return import_react15.default.createElement(UserButtonContext.Provider, { value: passableProps }, shouldShowFallback && fallback, clerk.loaded && import_react15.default.createElement(
      ClerkHostRenderer,
      {
        component,
        ...passableProps,
      ...
      import_react15.default.createElement(CustomPortalsRenderer, { ...portalProps })
    ));
  },
...
function UserButtonOutlet(outletProps) {
  ...
  return import_react15.default.createElement(ClerkHostRenderer, { ...portalProps });
}
...
var _OrganizationSwitcher = withClerk(
  ({
    ...
    return import_react15.default.createElement(OrganizationSwitcherContext.Provider, { value: passableProps }, import_react15.default.createElement(import_react15.default.Fragment, null, shouldShowFallback && fallback, clerk.loaded && import_react15.default.createElement(
      ClerkHostRenderer,
      {
        ...passableProps,
        hideRootHtmlElement: !!props.__experimental_asProvider
...
function ClerkContextProvider(props) {
  ...
  const clerkCtx = import_react31.default.useMemo(
    () => ({ value: clerk }),
    [
  ...
  const clientCtx = import_react31.default.useMemo(() => ({ value: state.client }), [state.client]);
  const {
    sessionId,
    sessionStatus,
    sessionClaims,
  ...
  const authCtx = import_react31.default.useMemo(() => {
    const value = {
      sessionId,
      sessionStatus,
      sessionClaims,
  ...
  const sessionCtx = import_react31.default.useMemo(() => ({ value: session }), [sessionId, session]);
  const userCtx = import_react31.default.useMemo(() => ({ value: user }), [userId, user]);
  const organizationCtx = import_react31.default.useMemo(() => {
    const value = {
      organization
    };
    return { value };
  ...
  return (
    ...
    import_react31.default.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, import_react31.default.createElement(ClientContext.Provider, { value: clientCtx }, import_react31.default.createElement(SessionContext.Provider, { value: sessionCtx }, import_react31.default.createElement(OrganizationProvider, { ...organizationCtx.value }, import_react31.default.createElement(AuthContext.Provider, { value: authCtx }, import_react31.default.createElement(UserContext.Provider, { value: userCtx }, import_react31.default.createElement(
...
var useLoadedIsomorphicClerk = (options) => {
  const isomorphicClerkRef = import_react31.default.useRef(IsomorphicClerk.getOrCreateInstance(options));
  const [clerkStatus, setClerkStatus] = import_react31.default.useState(isomorphicClerkRef.current.status);
  import_react31.default.useEffect(() => {
